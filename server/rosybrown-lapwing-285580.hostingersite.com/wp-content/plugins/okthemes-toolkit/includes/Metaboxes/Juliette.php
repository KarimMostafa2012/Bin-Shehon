...
class Juliette {
    ...
    private $global_prefix    = 'juliette_global_meta';
    private $post_prefix      = 'juliette_post_meta';
    private $page_prefix      = 'juliette_page_meta';
    private $product_prefix   = 'juliette_product_meta';
