...
class Orologio_Helper {
    ...
    public static function get_option( $option, $default = null ) {
        $options = get_option( 'orologio_options' );
    ...
    public static function check_default_header() {
        ...
        if ( is_page() || ( is_single() && 'post' === get_post_type() ) || is_home() ) {
            $page_default_header = self::get_meta( 'orologio_global_meta', 'page_default_header', 'default');
    ...
    public static function check_default_footer() {
        ...
        if ( is_page() || ( is_single() && 'post' === get_post_type() ) || is_home() ) {
            $page_default_footer = self::get_meta( 'orologio_global_meta', 'page_default_footer', 'default' );
    ...
    public static function get_global_colors() {
        ...
        $colors = [
            'primary_color' => [
                'slug'  => 'orologio-primary-color',
                'title' => esc_html__( 'Orologio Primary Color', 'orologio' ),
                'value' => $primary_color,
                'default' => $default_colors['primary_color'],
            ],
            'secondary_color' => [
                'slug'  => 'orologio-secondary-color',
                'title' => esc_html__( 'Orologio Secondary Color', 'orologio' ),
                'value' => $secondary_color,
                'default' => $default_colors['secondary_color'],
            ],
            'accent_color' => [
                'slug'  => 'orologio-accent-color',
                'title' => esc_html__( 'Orologio Accent Color', 'orologio' ),
                'value' => $accent_color,
                'default' => $default_colors['accent_color'],
            ],
            'accent_color_1' => [
                'slug'  => 'orologio-accent-color-1',
                'title' => esc_html__( 'Orologio Accent Color #1', 'orologio' ),
                'value' => $accent_color_1,
                'default' => $default_colors['accent_color_1'],
            ],
            'accent_color_2' => [
                'slug'  => 'orologio-accent-color-2',
                'title' => esc_html__( 'Orologio Accent Color #2', 'orologio' ),
                'value' => $accent_color_2,
                'default' => $default_colors['accent_color_2'],
            ],
            'body_background_color' => [
                'slug'  => 'orologio-body-background-color',
                'title' => esc_html__( 'Orologio Body Background Color', 'orologio' ),
                'value' => $body_background_color,
                'default' => $default_colors['body_background_color'],
            ],
            'header_background_color' => [
                'slug'  => 'orologio-header-background-color',
                'title' => esc_html__( 'Orologio Header Background Color', 'orologio' ),
                'value' => $header_background_color,
                'default' => $default_colors['header_background_color'],
            ],
            'footer_background_color' => [
                'slug'  => 'orologio-footer-background-color',
                'title' => esc_html__( 'Orologio Footer Background Color', 'orologio' ),
                'value' => $footer_background_color,
                'default' => $default_colors['footer_background_color'],
            ],
            'modules_background_color' => [
                'slug'  => 'orologio-modules-background-color',
                'title' => esc_html__( 'Orologio Modules Background Color', 'orologio' ),
