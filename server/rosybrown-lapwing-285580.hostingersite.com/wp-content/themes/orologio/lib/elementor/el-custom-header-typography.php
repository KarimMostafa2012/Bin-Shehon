...
class Orologio_Page_Header_Typography extends \Elementor\Core\Kits\Documents\Tabs\Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Page Header Typography', 'orologio' );
	}
	...
	protected function register_tab_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Page Header Typography', 'orologio' ),
				'tab' => $this->get_id(),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'label' => esc_html__( 'Heading', 'orologio' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Text Color', 'orologio' ),
		...
		$this->add_responsive_control(
			'page_header_padding',
			[
				'label' => esc_html__( 'Padding', 'orologio' ),
