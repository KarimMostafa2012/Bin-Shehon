...
if ( ! function_exists( 'orologio_is_okt_toolkit_activated' ) ) {
  function orologio_is_okt_toolkit_activated() {
      return class_exists('Okthemes_Toolkit');
  }
}

// Verify if WooCommerce is active
if ( ! function_exists( 'orologio_is_wc_activated' ) ) {
  function orologio_is_wc_activated() {
      return class_exists('woocommerce');
  }
}

// Verify if Elementor is active
if ( ! function_exists( 'orologio_is_elementor_activated' ) ) {
  function orologio_is_elementor_activated() {
    return class_exists( '\Elementor\Plugin' );
  }
}

// Verify if WPML is active
if ( ! function_exists( 'orologio_is_wpml_activated' ) ) {
    function orologio_is_wpml_activated() {
...
function orologio_kses_allowed_html($tags, $context) {
  switch($context) {
    case 'icon': 
      $tags = array( 
...
add_filter( 'wp_kses_allowed_html', 'orologio_kses_allowed_html', 10, 2);


function orologio_get_icons( $icon, $is_echo = false ) {
  $output = '';
    switch ( $icon ) { 
     ...
     ';
      ...
      //Orologio
      case 'theme-next-arrow':
        $output = '<svg style="overflow: visible;" class="circle-arrow-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 25" width="60" height="31">
            <circle class="circle" cx="34.769" cy="12.5" r="12.5" fill="#F8F2EC"/>
            <line class="line horizontal-line" x1="0" y1="13.4" x2="38.267" y2="13.4" stroke="#000" stroke-miterlimit="10" fill="none"/>
            <line class="line short-oblique"x1="38.026" y1="13.484" x2="32.56" y2="16.618" stroke="#000" stroke-miterlimit="10" fill="none"/>
            <line class="line" x1="37.903" y1="13.228" x2="29.503" y2="4.828" stroke="#000" stroke-miterlimit="10" fill="none"/>
        </svg>';
        break;
           
      case 'theme-prev-arrow':
        $output = '<svg style="overflow: visible;" class="circle-arrow-icon icon-theme-prev-arrow" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 25" width="60" height="31">
            <circle class="circle" cx="13.231" cy="12.5" r="12.5" fill="#F8F2EC"/>
            <line class="line horizontal-line" x1="48" y1="13.4" x2="9.733" y2="13.4" stroke="#000" stroke-miterlimit="10" fill="none"/>
            <line class="line short-oblique" x1="9.974" y1="13.484" x2="15.44" y2="16.618" stroke="#000" stroke-miterlimit="10" fill="none"/>
            <line class="line" x1="10.097" y1="13.228" x2="18.497" y2="4.828" stroke="#000" stroke-miterlimit="10" fill="none"/>
        </svg>';
        break;
      
      case 'simple-link-icon':
        $output = '<svg style="overflow: visible;" class="circle-arrow-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 25" width="60" height="31">
            <circle class="circle" cx="34.769" cy="12.5" r="12.5" fill="#F8F2EC"/>
            <line class="line horizontal-line" x1="0" y1="13.4" x2="38.267" y2="13.4" stroke="#000" stroke-miterlimit="10" fill="none"/>
            <line class="line short-oblique"x1="38.026" y1="13.484" x2="32.56" y2="16.618" stroke="#000" stroke-miterlimit="10" fill="none"/>
      ...
      case 'header-minicart-v2':
        $output = '<svg viewBox="0 0 24 24"><path d="m19.26 9.696 1.385 9A2 2 0 0 1 18.67 21H5.33a2 2 0 0 1-1.977-2.304l1.385-9A2 2 0 0 1 6.716 8h10.568a2 2 0 0 1 1.977 1.696zM14 5a2 2 0 1 0-4 0" stroke="#fff" stroke-linecap="round" stroke-linejoin="round"></path></svg>';
        break;

      case 'header-my-account-v2':
        $output = '<svg viewBox="0 0 24 24"><path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2z" stroke="#fff" stroke-linecap="round" stroke-linejoin="round"></path><path d="M4.271 18.346S6.5 15.5 12 15.5s7.73 2.846 7.73 2.846M12 12a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" fill="transparent" stroke="#fff" stroke-linecap="round" stroke-linejoin="round"></path></svg>';
        break;
      
      case 'add-to-cart':
        $output = '<svg viewBox="0 0 24 24"><path d="m19.26 9.696 1.385 9A2 2 0 0 1 18.67 21H5.33a2 2 0 0 1-1.977-2.304l1.385-9A2 2 0 0 1 6.716 8h10.568a2 2 0 0 1 1.977 1.696zM14 5a2 2 0 1 0-4 0" fill="transparent" stroke="#000" stroke-linecap="round" stroke-linejoin="round"></path></svg>';
        break;
  ...
  $output = apply_filters( 'orologio_svg_icon_element', $output, $icon );
  ...
  if ( ! $is_echo ) {
    return apply_filters( 'orologio_svg_icon', $output, $icon );
  }

  echo apply_filters( 'orologio_svg_icon', $output, $icon ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
}