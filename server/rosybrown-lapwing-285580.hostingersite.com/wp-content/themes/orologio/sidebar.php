...
//Get page options
$sidebar_select = Orologio_Helper::get_meta( 'orologio_global_meta', 'sidebar_select', 'default-sidebar',$post_id);
...
if (function_exists('dynamic_sidebar')) {
    ...
    if( orologio_is_wc_activated() && is_product() ) {
		
		$dynamic_sidebar = 'sidebar-product';

	} elseif( orologio_is_wc_activated() && is_woocommerce() ) {
